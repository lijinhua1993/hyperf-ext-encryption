...
namespace Lijinhua\HyperfExtEncryption\Driver;

use Lijinhua\HyperfExtEncryption\Contract\SymmetricDriverInterface;
...
class AesDriver implements SymmetricDriverInterface
{
     ...
     * @param  mixed  $value
     *
     * @throws \Lijinhua\HyperfExtEncryption\Exception\EncryptException
     */
     ...
     *
     * @throws \Lijinhua\HyperfExtEncryption\Exception\DecryptException
     */
