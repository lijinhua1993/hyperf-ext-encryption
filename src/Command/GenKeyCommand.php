...
namespace Lijinhua\HyperfExtEncryption\Command;
...
class GenKeyCommand extends HyperfCommand
{
    ...
    {
        parent::configure();
        $this->setDescription('Create a secret key or key-pair for lijinhua/hyperf-ext-encryption');
    }
    ...
    {
        $driverName = $this->choice('Select driver', array_keys($this->config->get('encryption.driver')), null, 1);
